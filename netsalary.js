...
let grossSalary = 200000;
let paye;
let nssf;
let nssfSelection = "oldRate";   // nssf options will be; "newRateTier1", "newRateTier2" & "oldRate"
let nhif;
...
// ........................NSSF.....................
// Basing on NEW RATES
// tier1 6% of gross to max of 6000 and tier2 6% of gross to max of 18000 and min of 6001
//  Basing on OLD RATES
// 5% of gross to max of 400
function calculateNssf(){
    if(nssfSelection === "newRateTier1"){
        nssf = grossSalary * 6/100;
        if(nssf > 6000){
            nssf = 6000;
        }
        return nssf;
    }else if(nssfSelection === "newRateTier2"){
        nssf = grossSalary * 6/100;
        if(nssf < 6001){
            nssf = 6001;
            return nssf;
